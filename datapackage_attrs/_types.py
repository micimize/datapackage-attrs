...
type_map: t.Dict[str, TypeInfo] = {
    "array": TypeInfo(py_type=list),  # t.List[t.Any]),
    ...
    "geojson": TypeInfo(py_type=dict),  # t.Any),
    "geopoint": TypeInfo(py_type=tuple),  # t.Tuple[Decimal, Decimal]),
    ...
    "yearmonth": TypeInfo(py_type=tuple),  # t.Tuple[int, int]),
}
